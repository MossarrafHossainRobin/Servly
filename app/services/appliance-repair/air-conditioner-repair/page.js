    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-600 text-lg mb-6">
          AC installation, cleaning, and maintenance.
        </p>

        <div className="flex items-center mb-6">
          <Star className="w-5 h-5 text-yellow-400" />
          <span className="ml-2 font-semibold text-gray-800">4.9</span>
          <span className="ml-1 text-gray-500">(110 reviews)</span>
        </div>

        <div className="flex gap-4 flex-wrap">
          <Link
            href="/chat/air-conditioner-repair"
          ...
          <Link
            href="/providers/air-conditioner-repair"
